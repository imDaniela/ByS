...
import 'package:bys_app/cobros_unificados/method_selector.dart';
...
class _CobrosUnificadosState extends State<CobrosUnificados>
  ...
  void _seleccionarFechaCobro(BuildContext context) async {
    DateTimeRange? picked = await showDateRangePicker(
      ...
      initialDateRange: DateTimeRange(
          start: fechaCobroPendienteInicial, end: fechaCobroPendienteFinal),
  ...
  void _loadCobros() {
    print(metodo);
    context.read<CobrosPendientesBloc>().add(GetCobrosPendientes(
          init: fechaCobroPendienteInicial,
          end: fechaCobroPendienteFinal,
          search: searchController.text,
        ));
    context.read<CobrosRealizadosBloc>().add(GetCobrosRealizados(
        init: fechaCobroPendienteInicial,
        end: fechaCobroPendienteFinal,
        search: searchController.text,
        metodo: metodo));
  ...
  Widget build(BuildContext context) {
    return _blocs(builder: (context, cobros, cobrosPedientes) {
      return Column(
        children: [
          MethodSelector(
            onChanged: (_metodo) {
            ...
            child: Stack(
              children: [
                TabBarView(
                  ...
                  children: [
                    CobrosRealizadosScreen(state: cobros, metodo: metodo),
  ...
  Widget _blocs(
      {required Widget Function(
              BuildContext, CobrosRealizadosState, CobrosPendientesState)
          builder}) {
